  ...
  return (
    <div className="flex flex-col items-center px-4 py-6 lg:ml-64">
      <div className="w-full max-w-2xl">
        ...
        {/* Coming Soon Glass Wall Overlay - Covers all content */}
        <div className="absolute inset-0 z-30 flex items-start justify-center pt-40 bg-black/60 backdrop-blur-sm rounded">
          <div className="text-center space-y-6 px-8">
            {/* Animated Nuclear Icon */}
            <div className="text-8xl text-lime-500 animate-spin-slow">
              ☢
            </div>

            {/* Coming Soon Text */}
            <div className="space-y-3">
              <h2 className="text-3xl font-black text-lime-500 tracking-widest animate-pulse">
                COMING SOON
              </h2>
              <p className="text-md text-gray-400 font-bold">
                SOL Battles launching soon...
              </p>
            </div>

            {/* Glowing Border Effect */}
            <div className="w-64 h-1 mx-auto bg-gradient-to-r from-transparent via-lime-500 to-transparent animate-pulse"></div>
