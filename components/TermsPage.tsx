  ...
  return (
    <div className="flex flex-col items-center px-4 py-6">
      <div className="w-full max-w-4xl">
        ...
        {/* Header */}
        <h1 className="lg:hidden text-2xl px-5 font-black tracking-[0.05em]" style={{ color: '#21bd5a', fontFamily: "'Orbitron', sans-serif" }}>TERMS OF SERVICE</h1>
        <p className="text-xs text-gray-400 mb-4 mt-4 px-5">Last Updated: December 2025</p>

        {/* Content */}
        <div className="bg-black/60 p-6 space-y-4 text-sm text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p className="text-xs text-gray-300 mb-2">You must meet the following requirements to use the Platform:</p>
            <ul className="list-disc list-inside space-y-1 ml-4 text-xs text-gray-300">
          ...
          <section>
            ...
            <p className="text-xs text-gray-300 mb-2">WARFOG.IO is a turn-based strategic defense game where:</p>
            <ul className="list-disc list-inside space-y-1 ml-4 text-xs text-gray-300">
          ...
          <section>
            ...
            <p className="mt-2 text-xs text-gray-300 ml-4">
          ...
          <section>
            ...
            <p className="text-xs text-gray-300 mb-2">The Platform offers the following match types:</p>
            <ul className="list-disc list-inside space-y-1 ml-4 text-xs text-gray-300">
              <li>Free Matches are available to all players including guests</li>
          ...
          {/* <section>
            ...
            <p className="text-xs text-gray-300 mb-2">When using wagered match features:</p>
            <ul className="list-disc list-inside space-y-1 ml-4 text-xs text-gray-300">
          ...
          <section>
            ...
            <p className="text-xs text-gray-300 mb-2">You may NOT:</p>
            <ul className="list-disc list-inside space-y-1 ml-4 text-xs text-gray-300">
            ...
            <p className="text-xs text-gray-300 mt-2">
              Violation of these terms may result in account ban.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-4 text-xs text-gray-300">
              ...
              <li>The Platform may experience downtime, bugs, or service interruptions</li>
              <li>We are not responsible for account issues caused by user error</li>
              <li>Online gaming results depend on skill and strategy</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-xs text-gray-300 mb-2">For questions about these Terms, contact us:</p>
